...
class CupyVector(vector):
    ...
    def __init__(self, in_vec):
        ...
        super(CupyVector, self).__init__()
    ...
    def maximum(self, other):
        if cp.isscalar(other):
            ...
            return self
        elif isinstance(other, CupyVector):
    ...
    def copy(self, other):
        ...
        if not isinstance(other, CupyVector):
    ...
    def clipVector(self, low, high):
        ...
        if not isinstance(low, CupyVector):
            raise TypeError("Provided input low vector not a vectorIC!")
        if not isinstance(high, CupyVector):
...
if __name__ == '__main__':
    ...
    x = CupyVector(np.empty((100, 200))).set(1.)
